...
const courses = [
  ...
  { 
    id: 3, 
    title: 'Risk Management Protcols', 
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-2 flex items-center gap-2">
            Master the markets. Elevate your edge.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6 relative z-10">
          ...
          <div className="glass-card p-8 border-indigo-500/20 relative overflow-hidden holo-border">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
              <div className="flex-1">
                <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-[0.2em] mb-2">Curriculum Status</p>
                <h3 className="text-2xl font-bold text-white mb-4">You are <span className="text-accent-primary">30%</span> through your curriculum.</h3>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-white/10">
              <div className="text-center">
                <p className="text-[10px] uppercase font-bold text-slate-500 tracking-widest mb-1">Hours Learned</p>
                <p className="text-xl font-bold font-mono text-white">4.5h</p>
              </div>
              <div className="text-center">
                <p className="text-[10px] uppercase font-bold text-slate-500 tracking-widest mb-1">Courses Completed</p>
                <p className="text-xl font-bold font-mono text-white">1</p>
              </div>
              <div className="text-center">
                <p className="text-[10px] uppercase font-bold text-slate-500 tracking-widest mb-1">Certificates</p>
                <p className="text-xl font-bold font-mono text-white">1</p>
              </div>
            </div>
          </div>

          <h3 className="text-sm font-bold text-white uppercase tracking-widest mt-8 mb-4">Available Courses</h3>
                  ...
                  <div className="p-5 rounded-xl bg-[#0a0a0a] flex flex-col md:flex-row items-start md:items-center gap-5 relative overflow-hidden">
                    ...
                    <div className="flex-1 w-full relative z-10">
                      ...
                      <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                        <div className="flex items-center gap-1.5"><BookOpen size={14} /> {course.modules} Modules</div>
        ...
        <div className="col-span-12 xl:col-span-4 space-y-6">
          ...
          <div className="glass-card p-6 border-accent-primary/20">
            <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-6">Current Focus</h3>
          ...
          <div className="glass-card p-6">
            <h3 className="text-sm font-bold text-white uppercase tracking-widest mb-6 flex items-center gap-2">
              <Award size={18} className="text-accent-secondary" /> Certificates
            </h3>
            ...
            <div className="p-4 rounded-xl border border-accent-secondary/20 bg-accent-secondary/5 relative overflow-hidden group">
              ...
              <div className="relative z-10 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Issued: May 02, 2026</p>
            ...
            <div className="mt-4 p-4 rounded-xl border border-white/5 bg-[#111] flex items-center justify-center min-h-[100px] text-center">
              <div>
                 ...
                 <p className="text-[10px] uppercase font-bold text-slate-500 tracking-widest">Complete more courses to unlock certificates</p>
              </div>
            </div>
          </div>
